		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Renegaciacao",
									"targetURL": "#comprestativunimedzfirenegotiation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprestativunimedzfirenegotiation-display": {
								"semanticObject": "comprestativunimedzfirenegotiation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prestativ.unimed.zfirenegotiation",
									"url": sap.ui.require.toUrl("com/prestativ/unimed/zfirenegotiation")
								}
							}
						}
					}
